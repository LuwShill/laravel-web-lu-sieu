							...
							<div class="row" style="margin-bottom:40px">
								<div class="col-xs-8">
									...
									<div class="form-group" >
					                    ...
					                    <img id="avatar" class="thumbnail" width="300px" src="img/th.jpg">
									</div>
									<div class="form-group" >
									...
									<div class="form-group" >
										...
										<select required name="cate" class="form-control">
											...
											<option value="3">Blucher</option>
											<option value="4">Brogues</option>
											<option value="5">Boat shoes</option>
											<option value="6">Driver shoes</option>
					                    </select>
									</div>
									<div class="form-group" >
