...
<head>
	...
	<!-- Favicon-->
	<link rel="shortcut icon" href="{{('public/frontend/img/fav.png')}}">
	<!-- Author Meta -->
		...
		<div class="main_menu">
			<nav class="navbar navbar-expand-lg navbar-light main_box">
				<div class="container">
					...
					<a class="navbar-brand logo_h" href="{{URL::to('/trangchu')}}"><img src="{{asset('public/frontend/img/fav.png')}}" alt=""> Xì Gòn Shop</a>
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
							<li class="nav-item active"><a class="nav-link" href="{{URL::to('/trangchu')}}">Home</a></li>
							...
							<li class="nav-item submenu dropdown">
								...
								<ul class="dropdown-menu">
									<li class="nav-item"><a class="nav-link" href="{{URL::to('admin/login')}}">Login</a></li>
				...
				<div class="col-lg-3  col-md-6 col-sm-6">
					<div class="single-footer-widget mail-chimp">
						...
						<ul class="instafeed d-flex flex-wrap">
							<li><img src="{{('public/frontend/img/i1.jpg')}}" alt=""></li>
							<li><img src="{{('public/frontend/img/i2.jpg')}}" alt=""></li>
							<li><img src="{{('public/frontend/img/i3.jpg')}}" alt=""></li>
							<li><img src="{{('public/frontend/img/i4.jpg')}}" alt=""></li>
							<li><img src="{{('public/frontend/img/i5.jpg')}}" alt=""></li>
							<li><img src="{{('public/frontend/img/i6.jpg')}}" alt=""></li>
							<li><img src="{{('public/frontend/img/i7.jpg')}}" alt=""></li>
							<li><img src="{{('public/frontend/img/i8.jpg')}}" alt=""></li>
						</ul>
					</div>
				</div>
